...
/*   Updated: 2021/01/12 18:46:20 by tclaudin         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Form::Form(std::string const &name, int exec, int sign, std::string const &target): _name(name), _target(target), _gradeSign(sign), _gradeExec(exec)
{
	_signed = false;
}
